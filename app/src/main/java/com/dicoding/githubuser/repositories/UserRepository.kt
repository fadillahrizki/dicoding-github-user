package com.dicoding.githubuser.repositories

import android.app.Application
import androidx.lifecycle.LiveData
import com.dicoding.githubuser.daos.UserDao
import com.dicoding.githubuser.databases.UserRoomDatabase
...
class UserRepository(application: Application) {
    ...
    fun getUser(id: Int): LiveData <User> = mUserDao.getUser(id)
    fun getAllUser(): LiveData <List<User>> = mUserDao.getAllUsers()
